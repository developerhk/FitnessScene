...
-(void) showBigImageWithUrl:(NSString *)url fromView:(UIImageView *)fromView complete:(void (^)(UIView *))complete
{
    ...
    UIImage* image1 = [[SDWebImageManager sharedManager] imageWithURL:[NSURL URLWithString:url]];
        if(image1!=nil){
        [self showBigImage:image1 fromView:fromView complete:complete];
    }else{
        UIImage* image2 = [[SDWebImageManager sharedManager] imageWithURL:[NSURL URLWithString:url]];
        if(image2!=nil){
...
{
    UIImage* image = [[SDWebImageManager sharedManager] imageWithURL:[NSURL URLWithString:url]];
    if(image){
