...
static StarZoneManager *instance = nil;

@implementation StarZoneManager
@synthesize rootPath = _rootPath;

+ (StarZoneManager *)sharedInstance {
    @synchronized(self){
        if(instance == nil){
            instance = [[StarZoneManager alloc] init];
...
- (id)init {
    if (self = [super init]) {
        ...
        // 创建新的版本
        NSString *newPath = [NSString stringWithFormat:@"%@", @"StarVideo"];
